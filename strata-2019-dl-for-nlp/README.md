# Deepl Learning Methodologies for NLP - Strata 2019
Slides and Code Tutorials for 2019 Strata Tutorial on Deep Learning Methodologies for Natural Language Processing
...
1. Go to your desktop by opening your terminal and entering `cd Desktop`.

2. Clone the repository by entering

    ```
    git clone https://github.com/GarrettHoffman/talks-and-tutorials.git
    ```

3. Move into this directory with `cd talks-and-tutorials/strata-2019-dl-for-nlp`.
...
3. After cloning the repo to your machine, navigate into the repo and enter
    ...
    ```
    docker build -t dl_for_nlp_<image_type> -f ./dockerfiles/Dockerfile.<image_type> ./dockerfiles/
    ```
...
4. Run the Docker image by entering
    ...
    ```
    docker run -it -p 8888:8888 -v ~/Desktop/talks-and-tutorials/strata-2019-dl-for-nlp:/root dl_for_nlp_<image_type>
    ```
